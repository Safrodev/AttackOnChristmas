...
public class ElvishBatEntityModel extends SinglePartEntityModel<ElvishBatEntity> {
    ...
    public ElvishBatEntityModel(ModelPart root) {
        this.root = root;
    ...
    public void setAngles(ElvishBatEntity batEntity, float f, float g, float h, float i, float j) {
